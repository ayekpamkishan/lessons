(function total() {
    ...
    function basic() {
        ...
        table = createElement('table', basicDiv, {
            id: 'basicTable'
        }, {
            height: "100%",
            width: "80%",
        ...
        for (var i = 0; i < 6; i++) {
            ...
            for (var j = 0; j < 4; j++) {
                ...
                createElement("button", row.insertCell(0), {
                    id: label[i][j],
                    type: "submit"
                }, {
                    width: "100%",
    ...
    function dt() {
        ...
        createElement("p", dateDiv, {}, {
            color: '#0000FF'
        }, {}, "ENTER A START TIME AND AN END TIME");
        table = createElement('table', dateDiv, {
            id: 'dateTable'
        }, {
            backgroundColor: "grey"
        }, null);
        ...
        for (var i = 0; i < 3; i++) {
            ...
            for (var j = 0; j < 3; j++) {
                ...
                if (j === 0)
                    ...
                    pl = "hr";
                createElement("input", row.insertCell(0), {
                    placeholder: pl,
                    id: id[i][j]
                }, {
                    width: "100%"
        ...
        createElement("button", table.insertRow(i).insertCell(0), {}, {
            width: "100%"
        }, {
            click: function() {
                timediff();
            }
        }, "Calculate"); //END OF TIME DIFFERENCE
        ...
        createElement("p", dateDiv, {}, {
            color: '#0000FF'
        }, {}, "ENTER A START TIME AND A TIME DURATION");
        table = createElement('table', dateDiv, {
            id: 'dateTable'
        }, {
            backgroundColor: "grey"
        ...
        }, "Calculate"); //END OF DATE DIFFERENCE
    ...
    function mort() {
        ...
        table = createElement('table', mortDiv, {
            'id': 'mort'
        }, {
            backgroundColor: "grey"
        }, " ");
        ...
        createElement("p", mortDiv, {
            id: "guide"
        }, {
            color: '#0000FF'
        }, {}, "Instructions: Enter any two value with a rate of interest to calculate the fourth value");
