...
?>
 ...
 <script src="func.js"></script>     
  ...
  <div onclick="tab1()" id="news" class="tc1"><center>News</center> </div>  
  <div onclick="tab2()" id="sub" class="tc2"><center>Subscribe</center></div>
    ...
    <div id="right" class="absoluteRight">
          ...
          <img src="tc.jpg">
    	   ...
    	   <button type="submit" onclick="" id="lern" class="l-button"><center>LEARN MORE</center></button>
    ...
    <div id="form" class="form1" >
        ...
        <div class="formleft">
              <table border="0" cellspacing="13" cellpadding="0">
                <tr>
                  <td><span class="label">Name<span class="error">*</span></span></td>
                  <td><input type="text" name="name" id="name" class="fsize" value="<?php echo $name;?>"></td>
                </tr>
                <tr>
                  <td><span class="label">Email<span class="error">*</span></span></td>
                  <td><input type="text" name="email" id="email" class="fsize" value="<?php echo $email;?>"></td>
                </tr>
                <tr>
                  <td><span class="label">Mobile<span class="error">*</span></span></td>
                  <td><input type="text" name="mobile" id="phone" class="fsize" value="<?php echo $mobile;?>"></td>
                </tr>
                <tr>
                  <td><span class="label">Sex<span class="error">*</span></span></td>
                  <td>
                ...
                <tr>
                  <td><span class="label">Interest<span class="error">*</span></span></td>
                  <td>
                    <input type="checkbox" name="interest[]" class="inter" <?php 
foreach($interest as $value){
  if($value == 'Football')
  echo "checked"; 
}  
?>  value="Football" ><span class="label">Football</span>

                    <input type="checkbox" name="interest[]" <?php 
foreach($interest as $value){
  if($value == 'Movie')
  echo "checked"; 
}  
?> value="Movie"class="inter"><span class="label">Movie</span>
...
?> value="Reading" class="inter"><span class="label">Reading
                  </span>
                  </td>
                </tr>
              </table>
            ...
            <div class="formright">
              <table border="0" cellspacing="13" cellpadding="0">
                <tr>
                  <td><span class="label">Country<span class="error">*</span></span></td>
                  <td><select id="country" name="country" class="fsize" onchange="State(this.value)" value="<?php echo $country;?>">
                      <option value="" > </option>
                ...
                <tr>
                  <td><span class="label" >States<span class="error">*</span></span></td>
                  <td><select id="state" name="state" class="fsize" <?php if ($state) { echo " selected"; } ?> value="" disabled>
                      <option value="-1"  > </option>
                      
                  </td>
                </tr>
                <tr>
                  <td valign="top"><span class="label">Address<span class="error">*</span></span></td>
   ...
   <button type="reset" id="rst" class="r-button"><center>RESET</center></button>
   <button type="submit" onclick="jsonval()" id="subscribe" class="s-button" name="subscribe"><center>SUBSCRIBE</center> <?php if (isset($_POST['subscribe'])) {
  ...
  <span class="error"><?php echo $interestErr;?></span><br><br>
        ...
        <span class="error"><?php echo $country;?></span><br>
         <span class="error"><?php echo $state;?></span><br>
          <span class="error"><?php echo $address;?></span><br> -->
           <span class="success"><?php echo $smsg;?></span><br> 
          </div>
</body>
</html>
