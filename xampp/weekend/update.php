...
$detail = "UPDATE  subscriptionTable set NAME='$name',EMAIL='$email',MOBILE='$mobile',SEX='$gender',INTEREST='$interest',COUNTRY='$country',STATE='$state',ADDRESS='$address' where MOBILE='$id1'";
